...
<p>
	<?php echo sprintf( __( 'If you would like to purchase %1$s, please visit the following <a href="%2$s">link</a>', 'in-stock-notifier' ), esc_html( $product_title ), esc_url( $product_link ) );?>
</p>
