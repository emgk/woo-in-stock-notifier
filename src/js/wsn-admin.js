...
jQuery( document ).ready( function( $ ) {
	...
	jQuery( 'ul.wsn-tabs__nav li.wsn-tabs__nav-item' ).click( function() {
		const tab_id = $( this ).attr( 'data-tab' );

		$( 'ul.wsn-tabs__nav li' ).removeClass( 'wsn-tabs__nav-item--current' );
		$( '.wsn-tabs__content' ).removeClass( 'wsn-tabs__content--current' );

		$( this ).addClass( 'wsn-tabs__nav-item--current' );
		$( '#' + tab_id ).addClass( 'wsn-tabs__content--current ' );
	} );
	...
	jQuery( '.wsn-users-list' ).on( 'click', 'a.removeUser', function( e ) {
		e.preventDefault();
	...
	jQuery( 'a#wsn_add_new_user' ).on( 'click', function( e ) {
		...
		const formid = jQuery( this ).data( 'product_id' );
